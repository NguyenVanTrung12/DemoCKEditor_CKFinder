(function(){CKEDITOR.dialog.add('wmplayer',
	...
	onShow:function(){this.getContentElement('general','content').getInputElement().setValue('');this.getContentElement('general','icon').getInputElement().setValue('')},
	onOk:function(){
					...
					if(exticon == "jpg" || exticon == "bmp" || exticon == "gif" || exticon == "jpeg" || exticon == "png" || exticon == "tga")
					{
						icon = '<img src="' + icon + '">';
